...
export default function DashboardPage() {
  ...
  const renderEvents = (events: UserEvents[]) => {
    return events.map(event => (
      <div key={event.id} className="p-4 bg-white dark:bg-gray-800 mb-2 rounded-md shadow-md overflow-auto">
  ...
  return (
    <div className="h-screen flex flex-col bg-gray-100 dark:bg-gray-900 p-6 overflow-hidden">
      ...
      <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 pb-2.5 z-10 position-relative">Your events: </h2>
